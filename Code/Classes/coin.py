...
class Coin(pg.sprite.Sprite):
    ...
    def __init__(self, x, y, score_group):
        ...
        self.sprite_sheet = prepare_game.GFX['coin']
        self.frames = []
        self.frame_index = 0
    ...
    def get_image(self, x, y, width, height):
        ...
        """
        Gets the image frames from the sprite sheet
        """
    ...
    def setup_frames(self):
        ...
        self.frames.append(self.get_image(47, 0, 8, 14))
        self.frames.append(self.get_image(0, 0, 7, 14))
        self.frames.append(self.get_image(15, 0, 8, 14))
        self.frames.append(self.get_image(31, 0, 8, 14))
