...
class Enemy(pg.sprite.Sprite):
    ...
    def setup_enemy(self, x, y, direction, name, setup_frames):
        ...
        """
        Sets up various values for the enemies
        """

        self.sprite_sheet = prepare_game.GFX['smb_enemies_sheet']
        self.frames = []
        self.frame_index = 0
    ...
    def set_velocity(self):
        ...
        """
        Sets velocity vector based on the enemy direction
        """
    ...
    def falling(self):
        ...
        """
        When the enemy falls off a ledge
        """
...
class EnemyA(Enemy):
    ...
    def __init__(self, y=c.GROUND_HEIGHT, x=0, direction=c.LEFT, name=c.ENEMYA):
        Enemy.__init__(self)
    ...
    def jumped_on(self):
        ...
        """
        When the main char squishes him
        """
...
class EnemyB(Enemy):
    ...
    def __init__(self, y=c.GROUND_HEIGHT, x=0, direction=c.LEFT, name=c.ENEMYB):
    ...
    def jumped_on(self):
        ...
        """
        When the main char jumps on the EnemyB and puts him in his shell
        """
    ...
    def shell_sliding(self):
        ...
        """
        When the EnemyB is sliding along the ground in his shell
        """
