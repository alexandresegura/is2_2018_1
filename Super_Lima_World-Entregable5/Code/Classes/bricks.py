...
class Brick(pg.sprite.Sprite):
    ...
    def __init__(self, x, y, contents=None, powerup_group=None, name='brick'):
        ...
        self.sprite_sheet = prepare_game.GFX['bricks']
    ...
    def opened(self):
        ...
        if self.contents == c.INVCHAR and self.powerup_in_box:
            self.group.add(powerups.InvChar(self.rect.centerx,
                                            self.rest_height))
...
class BrickPiece(pg.sprite.Sprite):
    ...
    def __init__(self, x, y, xvel, yvel):
        ...
        self.sprite_sheet = prepare_game.GFX['brick_piece']
        self.setup_frames()
        self.frame_index = 0
        self.image = self.frames[self.frame_index]
        self.rect = self.image.get_rect()
